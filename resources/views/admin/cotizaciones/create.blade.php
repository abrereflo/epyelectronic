                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" class="form-control search_client"
                                        placeholder="Buscar N° Codigo/carnet">
                                    ...
                                    <div class="input-group-append">
                                        <a type="button" class="btn btn-success text-uppercase" data-toggle="modal"
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group  clear"><input class="form-control "
                                                id="product_id_' + {{ $product->product_id }} + '" name="product_id[]"
                                                value="{{ $product->product_id }}" type="hidden">{{
                                    ...
                                    <td>
                                        <div class="form-group  clear"> <input
                                                ...
                                                value="{{ $product->stock }}" min="0" type="number">
                                    ...
                                    <td>
                                        <div class="form-group  clear"> <input
                                                ...
                                                onchange="sumTotal({{ $product->product_id }});"
                                                id="purchase_price_{{ $product->product_id }}" name="purchase_price[]"
                                                min="0" step="0.01" value="{{ $product->cost }}" type="number">
                                            <label class="text-danger alert_text"></label>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group  clear"> <input
                                                ...
                                                id="total_amount_{{ $product->product_id }}" type="number" min="0"
                                                step="0.01"> <label class="text-danger alert_text"></label> </div>
                                    </td>
                                    <td class="text-center"><a onclick="deleteInfo({{ $product->id }},this);"
