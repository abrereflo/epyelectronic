                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group text-uppercase">
                                            ...
                                            <input type="text" class="form-control text-uppercase" name="code" id="code" value="{{ $code_cli }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group text-uppercase">
                                    ...
                                    <div class="col">
                                        <div class="form-group text-uppercase">
                                            ...
                                            <input type="text" class="form-control text-uppercase" name="lastname" id="lastname"  placeholder="Apellidos">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group text-uppercase">
                                            ...
                                            <input type="text" class="form-control text-uppercase" name="ci" id="ci"  placeholder="Carnet de identidad">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group text-uppercase">
                                    ...
                                    <div class="col">
                                        <div class="form-group text-uppercase">
                                            ...
                                            <select class="custom-select form-control-border border-width-2 text-uppercase" name="city" id="city">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group text-uppercase">
                                            ...
                                            <input type="text" class="form-control text-uppercase" id="address" name="address"  placeholder="B/ Calle/ #...">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group text-uppercase">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group text-uppercase">
                                            ...
                                            <input type="text" class="form-control text-uppercase" name="nit" id="nit" placeholder="NIT/# documento">
                                        </div>
                                    </div>
                                </div>
                            </div>
