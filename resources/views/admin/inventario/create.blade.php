                    ...
                    <div class="card-header">
                        <div class="form-group text-uppercase">
                            <div class="input-group" id="search-proveedor">
                                <input id="proveedor_search" type="search" class="form-control" placeholder="Buscar Proveedor">
                        ...
                        <div class="row" id="listproveedor">
                            <div class="col">
                                <div class="text-left text-uppercase">
                                    <div class="col"><label for="" class="text-info">Nombre:</label></div>
                                    <div class="col"><label for="" class="text-info">Celuar:</label></div>
                                    <div class="col"><label for="" class="text-info">Direccion:</label></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-left text-info text-uppercase">
                                    <div class="col"><label for="" class="text-info">Razon Social:</label></div>
                                    <div class="col"><label for="" class="text-info">Celuar Corporativo:</label></div>
                                    <div class="col"><label for="" class="text-info">NIT o CI:</label></div>
                                </div>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="numero" placeholder="N° Factura / Recibo">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
...
<script>
    ...
    function sumTotal(id) {
        var total =  $('#purchase_price_' + id).val() / $('#quantity_' + id).val();
